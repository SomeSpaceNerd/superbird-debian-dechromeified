...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.KnobDisplay = QLabel(self.centralwidget)
        self.KnobDisplay.setObjectName(u"KnobDisplay")
        self.KnobDisplay.setGeometry(QRect(580, 210, 50, 20))
        font1 = QFont()
        font1.setPointSize(9)
        self.KnobDisplay.setFont(font1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.KnobDisplay.setText(QCoreApplication.translate("MainWindow", u"Knob", None))
